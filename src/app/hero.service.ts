...
export class HeroService {
  ...
  getHero(id: number): Observable<Hero> {
    //this.messageService.add(`HeroService: fetched hero id=${id}`); // Used in past steps of tutorial.
    //return of(HEROES.find(hero => hero.id === id)); // Used in past steps of tutorial.
